...
export default function CRM() {
  ...
  async function mover(row, etapa) {
    try {
      ...
      setError(err.missing ? `Preencha antes: ${err.missing.join(", ")}` : err.message);
    }
  }
